...
this.render=function(inx,link){$(link).wrap("<div class=\"flipmenu_box\"></div>");$(link).addClass(($(link).hasClass("current_page_item"))?"flipmenu_link_active":"flipmenu_link");var parent=$(link).parent()
...
this.onMouseEnter=function(event){var first=$(this.firstChild);if(first.hasClass("current_page_item"))
return;var second=first.next();first.animate({top:"-"+first.outerHeight()},250);second.animate({top:"0"},250);}
this.onMouseLeave=function(event){var first=$(this.firstChild);if(first.hasClass("current_page_item"))
